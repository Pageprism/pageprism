...
?>
	...
	<p><span class="label">Follow author URL: </span><?php echo form_input('follow_author_url', $data->follow_author_url);?></p>
	<p><span class="label">Memory piece URL: </span><?php echo form_input('memory_piece_url', $data->memory_piece_url);?></p>
