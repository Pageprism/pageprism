...
class SimpleLoginSecure
{
     ...
     * @param    string
     * @param    string
     * @param    bool :  if true user will be logged in after the registration
     * @return   bool
     */
...
//        'user_modified' => date('c'),
    ...
    function userExist($user_email = '')
    {
        ...
        if ($query->num_rows() > 0) {
            return true;//user_email already exists
        }
        return false;
    }
    ...
    function userInfo($user_email = '')
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            $res->email = $row->user_email;
            $res->created = $row->user_date;
            $res->las_login = $row->user_last_login;
            return $res;
        }
        return null;
    }
