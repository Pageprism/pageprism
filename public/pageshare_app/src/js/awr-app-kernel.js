!function (window, $) {
  ...
  !function () {
    ...
    __pushToBootQueue__(function __$init$__() {
      ...
      class Pageshare extends awr.App {
        static get $require() {
          return {
        ...
        constructor() {
          super(Pageshare.$require, Pageshare.name);
          this.controller = 'App';
          this.router.$watch();
          this.$start();
        }
    ...
    __pushToBootQueue__(function __$init$__() {
      ...
      class App extends awr.Config {
        ...
        constructor(name) {
          ...
          router.$authorize({
            routes: ['bookmarks-view', 'my-publisher-view', 'tags-view', 'users-view', 'upload-doc-view', 'my-collections-view', 'invite-view', 'edit-view'],
            authorizer: ['object:awr.superScope', function (superScope) {
              return Q.$objectExist(superScope.currentUser) ? Promise.resolve('Authorized') : Promise.reject('Not authorized');
            }],
